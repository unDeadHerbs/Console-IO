...
namespace udh{
  ...
  public:
    ...
    */
    ...
    // some sort of ability to have a printer function passed, and then just call that?
    basic_console& operator<<(basic_console* (*__pf)(basic_console&)){return __pf(*this);}
    /*
      ...
      basic_ostream& operator<<(ios_base& (*__pf)(ios_base&)){ __pf(*this); return *this; }
    */
